...
int main(int argc, char **argv) {
  ...
  Mat K = (Mat_<double>(3, 3) << 520.9, 0, 325.1, 0, 521.0, 249.7, 0, 0, 1);  // 相机内参矩阵已知
...
void bundleAdjustmentG2O(
  ...
  auto solver = new g2o::OptimizationAlgorithmGaussNewton(std::make_unique<BlockSolverType>(std::make_unique<LinearSolverType>()));  // 梯度下降方法，可以从GN, LM, DogLeg 中选，此处选择了g2o的高斯牛顿
